...
public class BodySymptomAdapter extends RecyclerView.Adapter<BodySymptomAdapter.MyViewHolder> {


    private Context mcontext;
    public static ArrayList<Symptom> bodySymptomList;

    public BodySymptomAdapter(Context mcontext, ArrayList<Symptom> symptomList) {
        this.mcontext = mcontext;
        this.bodySymptomList = symptomList;
    }
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        Symptom symptom = bodySymptomList.get(position);
        holder.bindView(symptom);
    }

    @Override
    public int getItemCount() {
        return bodySymptomList.size();
    }

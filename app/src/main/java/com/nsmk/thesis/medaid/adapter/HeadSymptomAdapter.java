...
public class HeadSymptomAdapter extends RecyclerView.Adapter<HeadSymptomAdapter.MyViewHolder> {


    private Context mcontext;
    public static ArrayList<Symptom> headSymptomList;

    public HeadSymptomAdapter(Context mcontext, ArrayList<Symptom> symptomList) {
        this.mcontext = mcontext;
        this.headSymptomList = symptomList;
    }
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        Symptom symptom = headSymptomList.get(position);
        holder.bindView(symptom);
    }

    @Override
    public int getItemCount() {
        return headSymptomList.size();
    }
